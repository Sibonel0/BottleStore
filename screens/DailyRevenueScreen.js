...
const DailyRevenueScreen = () => {
  ...
  const saveNotification = async () => {
    await fetch('http://10.150.14.245:3000/api/users/saveNotifications', {
      method: 'POST',
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const response = await fetch('http://10.150.14.245:3000/api/users/revenue', {
        method: 'POST',
        headers: {
      ...
      if (response.ok) {
        ...
        await fetch('http://10.150.14.245:3000/api/users/daily-summary', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json'
          },
